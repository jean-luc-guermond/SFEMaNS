...
#include "petsc/finclude/petsc.h"
  ...
  LOGICAL                                              :: if_momentum, if_mass
  LOGICAL                                              :: if_induction, if_energy
  ...
  SUBROUTINE run_SFEMaNS(time_in, it)
    ...
    IF (if_concentration) THEN
       ...
       CALL three_level_concentration(comm_one_d_conc, time, conc_1_LA, inputs%dt, list_mode, &
            conc_mesh, concn_m1, concn, v_to_conc, &
            ...
            inputs%convection_coeff_conc_lhs, inputs%convection_coeff_conc_rhs, &
            inputs%exterior_concentration, conc_per, j_H_to_conc)
    END IF
       ...
       IF (pp_mesh%me /= 0) THEN
          ...
          ELSE
             ...
             ELSE
                ...
                !Remark: LES is true when if_mass=.TRUE.
...
#include "petsc/finclude/petsc.h"
    ...
    INTEGER, DIMENSION(:), ALLOCATABLE :: list_dom, list_inter, part, list_dummy
    INTEGER, DIMENSION(:), ALLOCATABLE :: list_inter_temp, list_inter_conc
