...
The initial conditions, boundary conditions and the forcing terms are set in the file <tt>condlim_test_19.f90</tt>.
...
All the other subroutines present in the file <tt>condlim_test_19.f90</tt> are not used in this test.
...
We describe the data file of this test.
 It is called <tt>debug_data_test_19</tt> and can be found in the following directory: ($SFEMaNS_DIR)/MHD_DATA_TEST_CONV_PETSC.
<ol>
...
.01d0, 100
\endcode
<li>We write restart file every hundred time steps.
\code
===Frequency to write restart file
100
\endcode
These files are used by the test 20 that is a suite of the test 19.
...
<li>We use a BDF2 approximation of the time derivatives in the level set and momentum equations.
\code
...
These quantities are computed at the final time \f$t=1\f$.
 ...
 These values of reference are in the last lines of the file <tt>debug_data_test_19</tt> in the directory ($SFEMaNS_DIR)/MHD_DATA_TEST_CONV_PETSC. They are equal to:
\code
============================================
(Mesh_10_form.FEM)
===Reference results
2.1095497403641693E-003  L2 error on velocity
8.3993920604766903E-002  H1 error on velocity
5.6150434058516050E-003  L2 error on level set
4.7883926827950963E-003  L2 error on pressure
\endcode
...
<tr>
    <td align="center">
     @image html  fig_test_19_level_set_tfin.png "Level set in the plane plane y=0."
    </td>
    <td align="center">
    @image html  fig_test_19_density_tfin.png  "Density in the plane plane y=0."
    </td>
</tr>
<tr>
    <td align="center">
     @image html  fig_test_19_pre_tfin.png "Pressure in the plane plane y=0."
    </td>
    <td align="center">
    @image html  fig_test_19_vel_tfin.png  "Velocity magnitude in the plane plane y=0."
    </td>
</tr>
</table>
 */
