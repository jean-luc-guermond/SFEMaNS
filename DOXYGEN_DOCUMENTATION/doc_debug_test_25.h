...
/**
 * @page doc_debug_test_25 Test 25: Navier-Stokes with variable density and viscosity
...
\\ \rho(r,\theta,z,t) &=1+r^2+z^2,
\\ \eta(r,\theta,z,t) &=1+r^2+z^2.
@f}
...
The finite element mesh used for this test is named <tt>Mesh_20_form.FEM</tt> and 
...
The initial conditions, boundary conditions and the forcing terms are set in the file <tt>condlim_test_25.f90</tt>.
...
All the other subroutines present in the file <tt>condlim_test_25.f90</tt> are not used in this test.
...
We describe the data file of this test.
 It is called <tt>debug_data_test_25</tt> and can be found in the following directory: ($SFEMaNS_DIR)/MHD_DATA_TEST_CONV_PETSC.
<ol>
...
These quantities are computed at the final time \f$t=1\f$.
 ...
 These values of reference are in the last lines of the file <tt>debug_data_test_25</tt> in the directory ($SFEMaNS_DIR)/MHD_DATA_TEST_CONV_PETSC. They are equal to:
\code
============================================
(Mesh_10_form.FEM)
===Reference results
1.7489114810423408E-004  L2 error on velocity
1.2910619903393045E-003  H1 error on velocity
4.5642002105875500E-003  L2 error on level set
1.3778684387869890E-005  L2 error on pressure
\endcode
...
<tr>
    <td align="center">
     @image html  fig_test_25_level_set_tfin.png "Level set in the plane plane y=0."
    </td>
    <td align="center">
    @image html  fig_test_25_density_tfin.png  "Density in the plane plane y=0."
    </td>
</tr>
<tr>
    <td align="center">
     @image html  fig_test_25_pre_tfin.png "Pressure in the plane plane y=0."
    </td>
    <td align="center">
    @image html  fig_test_25_vel_tfin.png  "Velocity magnitude in the plane plane y=0."
    </td>
</tr>
</table>
 */
